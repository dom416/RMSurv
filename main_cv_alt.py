...
from model.train_HFB import train_HFB, test_HFB
from model.train_HFB_cox import train_HFB_cox, test_HFB_cox
...
for seed in range(1,11):
    ...
    for fold in range(1, 6):
        ...
        #model2, optimizer, metric_logger = train_HFB(opt, train_data, test_data, device)
        #_, cindex_one, embeddings_two, case_ids_two = test_HFB(opt, model2, train_data, device) #, embeddings_one, case_ids_one
        #print(f"[Final] Training set C-Index (modality 2): {cindex_one:.10f}")
        #_, cindex_one, embeddings_two, case_ids_two = test_HFB(opt, model2, test_data, device)  #, embeddings_one, case_ids_one
        #print(f"[Final] Testing set C-Index (modality 2): {cindex_one:.10f}")
