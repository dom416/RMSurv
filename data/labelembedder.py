...
def save_data_by_case_id(parquet_file_directory, config_name):
    ...
    base_directory = "/home/daf6674/lambda-stack-with-tensorflow-pytorch/LUAD_fusion/LUAD_LUSC_data/LUAD/"
...
# Example usage
save_data_by_case_id('/home/daf6674/lambda-stack-with-tensorflow-pytorch/LUAD_fusion/HoneyBeemain/HoneyBeemain/embeddings/TCGA-LUAD/', 'clinical_data')
