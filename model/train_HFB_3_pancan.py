...
from HFBSurvmain.HFBSurvmain.HFBSurv.model.HFB_fusion import HFBSurv
...
def train_HFB(opt,train_data,test_data,device):
    ...
    random.seed(666)
    model = HFBSurv((38943, 634, 210), (48, 48, 48, 256), (20, 20, 20), (0.2, 0.2, 0.2, 0.4), 20, 0.1).to(device)
