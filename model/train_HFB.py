...
from model.HFB_fusion import HFBSurv
...
def train_HFB(opt,train_data,test_data,device):
    ...
    random.seed(666)
    model = HFBSurv((4, 3584, 1012), (48, 48, 48, 256), (20, 20, 20), (0.2, 0.2, 0.2, 0.4), 20, 0.1).to(device)
    ...
    for epoch in tqdm(range(opt.epoch_count, opt.niter+50+1)):
        ...
        for batch_idx, batch in enumerate(train_loader):
            ...
            pred, embeddings = model(x_clin,x_pathr,x_mirna) 
            # for SNN only
